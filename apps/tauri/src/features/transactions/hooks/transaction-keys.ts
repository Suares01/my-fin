...
export const transactionKeys = {
  ...
  summaries: (bookId: string) =>
    [...transactionKeys.all(bookId), "summary"] as const,
  summary: (bookId: string, filters: TransactionSummaryFilters) =>
    [...transactionKeys.summaries(bookId), filters] as const,
