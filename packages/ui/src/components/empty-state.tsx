...
> = {
  accounts: {
    ...
    description:
      "Conecte suas contas bancárias para consultar saldos, acompanhar gastos e gerenciar tudo em um só lugar.",
  },
  transactions: {
    illustration: <TransactionIllustration />,
    title: "Nenhuma transação ainda",
    description:
      "Suas transações aparecerão aqui assim que você vincular uma conta ou fizer sua primeira transferência.",
  },
  cards: {
    illustration: <CardIllustration />,
    title: "Nenhum cartão adicionado",
    description:
      "Adicione um cartão físico ou virtual para gerenciar limites de gastos, bloquear cartões e acompanhar pagamentos.",
  },
  transfers: {
    illustration: <TransactionIllustration />,
    title: "Nenhuma transferência ainda",
    description:
      "Envie dinheiro para amigos, familiares ou empresas. Seu histórico de transferências aparecerá aqui.",
  },
  investments: {
    illustration: <ChartIllustration />,
    title: "Nenhum investimento",
    description:
      "Comece a montar sua carteira conectando uma conta de corretora ou fazendo seu primeiro investimento.",
  },
  crypto: {
    illustration: <ChartIllustration />,
    title: "Nenhum ativo de criptomoeda",
    description:
      "Compre, venda ou transfira criptomoedas para começar. Os preços em tempo real são atualizados a cada 3 segundos.",
  },
  analytics: {
    illustration: <ChartIllustration />,
    title: "Dados insuficientes",
    description:
      "As análises ficarão disponíveis quando você tiver pelo menos um mês de histórico de transações.",
  },
  budgets: {
    illustration: <ChartIllustration />,
    title: "Nenhum orçamento definido",
    description:
      "Crie seu primeiro orçamento para acompanhar gastos por categoria e receber alertas quando estiver perto dos limites.",
  },
  notifications: {
    illustration: <BellIllustration />,
    title: "Está tudo em dia!",
    description:
      "Você não tem notificações no momento. Avisaremos quando algo precisar da sua atenção.",
  },
  search: {
    illustration: <SearchIllustration />,
    title: "Nenhum resultado encontrado",
    description:
      "Tente ajustar os termos da busca ou verifique se há erros de digitação.",
  },
  filter: {
    illustration: <SearchIllustration />,
    title: "Nenhum resultado correspondente",
    description: "Nenhum item corresponde aos filtros atuais.",
  },
  generic: {
    illustration: <GenericIllustration />,
    title: "Nada aqui ainda",
    description:
      "Esta seção está vazia. O conteúdo aparecerá aqui quando houver dados disponíveis.",
  },
}
