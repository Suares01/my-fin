...
describe("TauriIdGenerator", () => {
  it("uses UUID v4 for all nine branded operations", () => {
    const values = [
    ...
    const generated = [
      ...
      generator.nextInvestmentInstrumentId(),
      generator.nextInvestmentPositionId(),
      generator.nextInvestmentOperationId(),
      generator.nextInvestmentValuationId(),
    ...
    expect(new Set(generated)).toHaveLength(9)
  })
